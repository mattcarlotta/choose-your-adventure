            ...
            <div className="flex min-h-screen flex-col items-center justify-center p-24">
                <section className="text-center flex flex-col justify-center items-center space-y-1.5">
                    ...
                    <header className="!mt-6">
                        <h1 className="title text-5xl font-bold uppercase">Kady, Choose Your Adventure!</h1>
                    </header>
                    <h2 className="text-xl text-gray-300 tracking-wide">
                        I wanted <span className="text-yellow-500">your</span> input, so I made this for <span className="text-red-500">you</span>. I hope you like it!
                    </h2>
                    <Link
