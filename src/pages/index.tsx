        ...
        <>
            ...
            <div className="flex flex-col items-center justify-center min-h-screen p-8 sm:p-24">
                <section className="flex flex-col justify-center items-center space-y-1.5 text-center">
                    <Image
                        priority
                        src="/choose-adventure.avif"
                        alt="Choose an adventure"
                        height={325}
                        width={325}
                    ...
                    <header className="!mt-6">
                        <h1 className="title text-xl font-bold uppercase sm:text-5xl">
                            {process.env.NEXT_PUBLIC_DATE_NAME}, Choose Your Adventure!
                        </h1>
                    </header>
                    <h2 className="text-gray-300 tracking-wide sm:text-xl">
                        I wanted <span className="text-yellow-500">your</span> input for a{' '}
                        <span className="text-orange-500">second date</span>, so I made this for{' '}
                        <span className="text-red-500">you</span>. I hope you like it!
                    </h2>
                    <Link
