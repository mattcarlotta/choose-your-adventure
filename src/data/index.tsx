...
export const ADVENTURES = [
    {
        ...
        title: "Mini Golf",
        description: "Join me for a fantastic time playing mini-golf! Imagine a vibrant 18 course filled with quirky challenges like looping ramps, tricky water hazards, and whimsical obstacles. Mini-golf offers a blend of friendly competition and laughter as we aim for that elusive hole-in-one. Gather your wits, grab your putters, and let's tee off for a memorable game!",
    ...
    },
    {
        ...
        title: "Axe Throwing",
        description: "Join me for an exhilarating experience of throwing axes at targets! Picture this: a backdrop of wooden boards with painted bullseyes, a line marked for throwing, and a collection of well-balanced axes waiting to be launched. Feel the rush of adrenaline as you step up to the line, axe in grip and watch it fly across the room as it ricohets off the target!",
    ...
    },
    {
        ...
        title: "Alpaca Farm",
        description: "Join me for an enchanting visit to an alpaca farm, where we'll immerse ourselves in the charm and tranquility of these gentle creatures. Picture rolling grasses dotted with fluffy alpacas grazing peacefully and their curious eyes and soft fleece inviting us to feed them. Let's embark on this unforgettable journey and let the magic of alpacas brighten our day!",
    ...
    },
    {
        ...
        description: "Join me for an exciting ice skating lesson that promises thrills and skill-building! Imagine gliding gracefully across a glistening rink, feeling the crisp air against your face. You'll learn the fundamental moves like forward skating, stopping techniques, and maybe even some fun spins. Lace up your skates and let's hit the ice for an unforgettable skating adventure!",
    ...
    },
    {
        ...
        title: "Movie Night",
        description: "Join me for an unforgettable movie night filled with laughter, snacks, and great company! Picture cozying up together, surrounded by soft blankets and pillows. Whether we're cheering for the heroes, solving mysteries, or shedding a tear at touching moments, movie night is all about relaxing. Grab your favorite snacks, pick out a comfy spot, and let's dive into a cinematic journey!",
        location: "Any",
        difficulty: "Normal",
