    ...
    return (
        <>
            <div className="border border-gray-600 p-2 rounded">
                ...
                >
                    ...
                    <div className="flex flex-col space-y-0.5 backshadow">
                        ...
                        <p className="text-xs text-gray-300 sm:text-sm">Location: {location}</p>
            ...
            {showModal
                ? createPortal(
                      <div
                          className="fixed bottom-0 top-0 z-10 flex h-full w-full justify-center bg-black bg-opacity-70 focus:outline-none items-center"
                          role="presentation"
                      >
                          <div
                                  ...
                                  {
                                      {
                                          [ADVENTURE_STATUS.UNAVAILABLE]: (
                                              <>
                                                  ...
                                                  />
                                                  <p className="mt-4">
                                                      Sorry explorer, but you&apos;ve already{' '}
                                          ...
                                          [ADVENTURE_STATUS.LOCKED]: (
                                              <>
                                                  ...
                                                  <p className="mt-4">
                                                      ...
                                                      to enter this area yet.
                                                  </p>
                                                  <p className="mt-4 sm:mt-0">
                                                      Return once you&apos;ve purchased the deluxe{' '}
